...
void test_map_key_value_pair_list_serialize_deserialize(void)
{
	...
	kv_pair_list = lttng_map_key_value_pair_list_create(identifier);
...
void test_map_content_serialize_deserialize(void)
{
	...
	struct lttng_map_key_value_pair_list *kv_pair_list1, *kv_pair_list2;
	...
	kv_pair_list1 = lttng_map_key_value_pair_list_create(id1);
	kv_pair_list2 = lttng_map_key_value_pair_list_create(id2);
	...
	ok(map_status == LTTNG_MAP_STATUS_OK, "Got key value pair count");
	ok(list_count == 2, "Got the expected key-value list count");
