...
/* TODO: the new event-notifier client might not be present in previous
 * lttng-modules should it be optional?
 * Can we reuse this to also know of the event-notifier feature is supported?
 */
struct kern_modules_param kern_modules_control_core[] = {
	...
	{ (char *) "lttng-ring-buffer-event-notifier-client" },
