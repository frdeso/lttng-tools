...
/*
 * Query the values of all uid (or uid) or just some.
 */
...
extern enum lttng_map_query_status lttng_map_query_set_sum_by_app_bitness(
...
extern enum lttng_map_query_status lttng_map_query_set_sum_by_uid(
